            ...
            {mode === "brief" ? (
              ...
              <div id="guided-form" className="guided-panel">
                ...
                <div className="form-row form-row-budget">
                  ...
                  <div className="form-field"><Label htmlFor="gpu-preference">GPU preference</Label><Input id="gpu-preference" value={requirements.gpuPreference ?? ""} placeholder="e.g. RTX 4060" onChange={(event) => updateRequirement("gpuPreference", event.target.value || undefined)} /></div>
